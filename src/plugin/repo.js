...
const handleRepoCommand = async (m, Matrix) => {
  const repoUrl = 'https://github.com/Joygoodboy/MIRAGE-MD-V1.7.4';
  try {
        ...
        message: {
          ...
          interactiveMessage: proto.Message.InteractiveMessage.create({
            ...
            footer: proto.Message.InteractiveMessage.Footer.create({
              text: "© Powered By MIRAGE-MD V1.7.4"
            }),
              ...
              buttons: [
                ...
                },
                {
                  ...
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: `https://github.com/Joygoodboy/MIRAGE-MD-V1.7.4/fork`
                  })
                },
                {
                  name: "cta_url",
                  buttonParamsJson: JSON.stringify({
                    ...
                    url: `https://whatsapp.com/channel/0029VaR5tqV5a23wYRkR7O3Y`
                  })
                }
              ],
            }),
